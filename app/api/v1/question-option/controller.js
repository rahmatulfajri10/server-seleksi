        ...
        .on('data', (row) => {
            ...
            if (rowData[5] == 1) {
                question.tbl_options = [
                    { option: rowData[6], score: parseInt(rowData[7]), has_foto: parseInt(rowData[8]), url_foto: rowData[9] },
                    { option: rowData[10], score: parseInt(rowData[11]), has_foto: parseInt(rowData[12]), url_foto: rowData[13] },
                    { option: rowData[14], score: parseInt(rowData[15]), has_foto: parseInt(rowData[16]), url_foto: rowData[17] },
                    { option: rowData[18], score: parseInt(rowData[19]), has_foto: parseInt(rowData[20]), url_foto: rowData[21] },
                ].filter(option => option.option != null); // Filter out any options that are null
            }
            if (rowData[22]){
                question.tbl_options.push({ option: rowData[22], score: parseInt(rowData[23]), has_foto: parseInt(rowData[24]), url_foto: rowData[25] });
            }
            data.push(question);
